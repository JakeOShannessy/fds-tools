...
use nom::{
    ...
    character::complete::{
        alphanumeric1, anychar, char, crlf, digit1, multispace0, newline, none_of, one_of, space0, line_ending, not_line_ending
    },
...
pub fn parse_smv_file<'a, 'b>(
    i: &'b str,
) -> IResult<&'b str, SMVFile> {
...
fn parse_obst_line1(i: &str) -> IResult<&str, ((f64, f64, f64, f64, f64, f64),i64,(u64,u64,u64,u64,u64,u64))> {
    let (i,_) = space0(i)?;
